 ...
 * @author User
 */
public class PhotoMusic extends javax.swing.JFrame {

    /**
     * Creates new form PhotoMusic
     */
    public PhotoMusic() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhotoMusic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhotoMusic().setVisible(true);
            }
        });
    }
